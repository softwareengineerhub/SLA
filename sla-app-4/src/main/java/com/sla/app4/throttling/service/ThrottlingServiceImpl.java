...
import com.sla.app4.sla.service.SlaServiceImpl;
import com.sla.app4.sla.service.SlaService;
import static com.sla.app4.sla.service.SlaService.DEFAULT_TOKEN;
...
public class ThrottlingServiceImpl implements ThrottlingService {
    ...
    public boolean isRequestAllowed(Optional<String> token) {
        ...
        try {
            result = sla.getBlockingQueue().tryOffer("token");
            return result;
        } catch (Exception ex) {
            return false;
        }
